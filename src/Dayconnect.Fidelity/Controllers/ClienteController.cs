...
namespace Dayconnect.Fidelity.Controllers
{
    ...
    public class ClienteController : ControllerBase
    {
        ...
        [Authorize(Policy = "Operar")]
        [AcoesFilterAttribute]
        public async Task<IActionResult> InativaCliente([FromBody, SwaggerRequestBody("A signature para inativar o cliente Dayconnect", Required = true)] InativarClienteSignature signature)
        {
